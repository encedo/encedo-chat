...
switch (cmd) {
  ...
  default:
    console.log('usage: alice <register --hsm <url> [--handle h]|pubkey|list [--pattern ETSEIC:] --hsm <url>|topic <peer> --peer-pub <b64>|join <peer> --peer-pub <b64> [--network m] [--date d]>  [--password pw]')
}
