...
const CATALOG: Record<string, Record<string, Entry>> = {
  ...
  en: {
    ...
    'Ten link możesz powiesić publicznie. Kto go ma, może do Ciebie zapukać — a Ty decydujesz, kogo przyjmiesz.': 'You can post this link publicly. Anyone who has it can knock — and you decide who gets in.',
    'np. dla czytelników': 'e.g. for readers',
    'Czas życia': 'Lifetime',
    'Bez końca — dopóki sam nie wycofasz': 'No end — until you withdraw it',
    '24 godziny': '24 hours',
    '7 dni': '7 days',
    '30 dni': '30 days',
    'Do konkretnej daty i godziny': 'Until a specific date and time',
    'Po tym czasie przestajesz słuchać na tym zaproszeniu. Link dalej istnieje, ale pukanie nie dojdzie już do nikogo — i nikt po drugiej stronie nie dowie się, kiedy to nastąpiło.': 'After that you stop listening on this invite. The link still exists, but a knock will reach nobody — and no one on the other side learns when that happened.',
    'Podaj datę i godzinę.': 'Give a date and time.',
    'Ta chwila już minęła.': 'That moment has already passed.',
    'Zmień nazwę i czas życia': 'Change the name and lifetime',
    'Zaproszenie „{label}" wygasło': 'The invite "{label}" has expired',
    'wygasło': 'expired',
    'do {when}': 'until {when}',
    'To zaproszenie wygasło — nikt się na nie nie dopuka. Przedłuż je albo zrób nowe.': 'This invite has expired — nobody can knock on it. Extend it or make a new one.',
    ...
    '+ Nowe zaproszenie': '+ New invite',
    'Jesteś w środku. Teraz potrzebujesz drugiej osoby.': "You're in. Now you need somebody to talk to.",
    '(brak kontaktów — dodaj peera)': '(no contacts — add a peer)',
    'Nie ma tu listy użytkowników, której można by poszukać — kontakt powstaje dopiero wtedy, gdy obie strony mają swoje klucze publiczne. Od tego momentu treść jest szyfrowana end-to-end i żaden serwer po drodze jej nie widzi.': 'There is no directory of users to search — a contact exists once both sides hold the other\'s public key. From then on the content is end-to-end encrypted and no server along the way sees it.',
    'Wyślij swój profil': 'Send somebody your profile',
    'Dla kogoś, kogo znasz. Wymieniacie się kluczami i każde z Was sprawdza odcisk drugiego. Nikt się do Ciebie nie odezwie, dopóki sam nie weźmiesz jego klucza.': 'For somebody you know. You exchange keys and each of you checks the other\'s fingerprint. Nobody can reach you until you have taken their key yourself.',
    'Opublikuj zaproszenie': 'Publish an invite',
    'Jeden link, który możesz gdziekolwiek powiesić. Kto go ma, może zapukać — zobaczysz odcisk i notatkę, i zdecydujesz. Pukanie odbierzesz, gdy aplikacja jest otwarta; druga strona ponawia.': 'One link you can hang anywhere. Whoever has it can knock — you see a fingerprint and a note, and you decide. A knock reaches you while the app is open; the other side keeps trying.',
    'Mam czyjeś zaproszenie': 'Somebody gave me an invite',
    'Wklej link albo sam kod, który ktoś Ci podał.': 'Paste the link, or just the code you were given.',
    'Zmień nazwę tożsamości': 'Rename this identity',
    'Zmieni się u Ciebie i w nowych zaproszeniach. Kontakty, które już Cię mają, dalej widzą nazwę, którą sami Ci nadali.': 'It changes here and in invites sent from now on. Contacts who already have you go on seeing the name they gave you themselves.',
    'Potwierdź hasłem': 'Confirm with your password',
    'Nazwa siedzi w zapieczętowanym profilu, więc zmiana wymaga hasła.': 'The name lives inside the sealed profile, so changing it needs the password.',
    'Nazwa jest za długa — limit to {n} bajtów': 'That name is too long — the limit is {n} bytes',
    'Profil o tej nazwie już tu jest — wybierz inną.': 'A profile with that name is already here — pick another.',
    'Nazwa zmieniona na {name}': 'Renamed to {name}',
    ...
    'prosto do drugiej przeglądarki — do {mb} MB, nic nie trafia na serwer': 'straight to the other browser — up to {mb} MB, nothing reaches a server',
